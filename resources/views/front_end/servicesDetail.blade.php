                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                        ...
                                        <div class="dropzone-main">
                                            <div action="/appointment/image" class="dropzone" id="my-awesome-dropzone">
                                                <div class="dz-message" data-dz-message><span>Click or drag files to this
                                                        area to upload.</span><br><span class="dropzone-sub-title">You can
                                                        upload up to 3 files.</span></div>
                                            </div>
                ...
                @foreach ($serviceBefore as $serviceBe)
                    <div class="new-container w-full sm:w-1/2 md:w-1/3 p-2">
                        <div class="new-image-container">
                            <img class="new-image-before new-slider-image"
                                src="{{ asset('storage/' . $serviceBe->image_before) }}"
                                alt="Mobile Smash Repair Services" />
                            <img class="new-image-after new-slider-image"
                                src="{{ asset('storage/' . $serviceBe->image_after) }}"
                                alt="Mobile Smash Repair Services" />
                        </div>
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                <div class="relative p-2 sm:p-4 md:p-6">
                    <img src="{{ asset('asset/images/1.jpg') }}" alt="Mobile Smash Repair Services"
                        class="w-full h-auto sm:h-60 md:h-72 lg:h-80 object-fit transition duration-300 transform hover:scale-105">
                </div>

                <div class="relative p-2 sm:p-4 md:p-6">
                    <img src="{{ asset('asset/images/2.jpg') }}" alt="Mobile Smash Repair Services"
                        class="w-full h-auto sm:h-60 md:h-72 lg:h-80 object-fit transition duration-300 transform hover:scale-105">
                </div>

                <div class="relative p-2 sm:p-4 md:p-6">
                    <img src="{{ asset('asset/images/3.jpg') }}" alt="Mobile Smash Repair Services"
                        class="w-full h-auto sm:h-60 md:h-72 lg:h-80 object-fit transition duration-300 transform hover:scale-105">
                </div>
            </div>
        </div>
                    ...
                    @foreach ($faqs as $faq)
                        <div class="bg-white rounded-lg shadow-md">
                            <button
                                ...
                                <svg id="icon-faq-{{ $faq->id }}" xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 transition-transform transform rotate-0" fill="none"
        ...
        <div class="bg-[#15AEF1] rounded-lg p-6 sm:p-12">
            ...
            <form action="{{ route('appointment.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="w-full gap-1 mt-2">
                    ...
                    <div class="dropzone-main">
                        <div action="/appointment/image" class="dropzone" id="my-awesome-dropzone2">
                            <div class="dz-message" data-dz-message><span>Click or drag files to this area to
                                    upload.</span><br><span class="dropzone-sub-title">You can upload up to 3 files.</span>
                            </div>
                        </div>
                ...
                <div class="w-full gap-1 mt-2">
                    ...
                    <textarea id="msg" placeholder="Your message" name="msg" rows="4"
                    ...
                    if (response.status) {
                        ...
                        setTimeout(function() {
                            ...
                            newElement.innerHTML =
                                '<div class="me-5"><img class="dropzone-img" src="/storage/' +
                                response.data.image +
                                '"></div><div><p class="text-dark">asas45a4s5a4sasa54s</p><p class="dropzone-remove" onclick="removeImage(this)">Remove</p><input type="hidden" name="car_image[]" value="' +
                                response.data.id + '"></div>';
                            ...
                            if (childCount >= 3) {
                                ...
                                var myAwesomeDropzone = document.getElementById(
                                    "my-awesome-dropzone");
                    ...
                    if (response.status) {
                        ...
                        setTimeout(function() {
                            ...
                            newElement.innerHTML =
                                '<div class="me-5"><img class="dropzone-img" src="/storage/' +
                                response.data.image +
                                '"></div><div><p class="text-dark">asas45a4s5a4sasa54s</p><p class="dropzone-remove" onclick="removeImage(this, \'footer\')">Remove</p><input type="hidden" name="car_image[]" value="' +
                                response.data.id + '"></div>';
                            carImageList.appendChild(newElement);
